...
ut = FieldTimeSeries("flow_past_headland_16_xy.jld2", "u")
Tt = FieldTimeSeries("flow_past_headland_16_xy.jld2", "T")
wt = FieldTimeSeries("flow_past_headland_16_xy.jld2", "w")
ζt = FieldTimeSeries("flow_past_headland_16_xy.jld2", "ζ")
Nt = length(ut)
x, y, z = nodes(ut)
...
axu = Axis(fig[1, 1], aspect=1, xlabel="x (m)", ylabel="y (m)", width=500, height=400)
...
axT = Axis(fig[1, 2], aspect=1, xlabel="x (m)", ylabel="y (m)", width=500, height=400)
...
axw = Axis(fig[3, 1], aspect=1, xlabel="x (m)", ylabel="y (m)", width=500, height=400)
...
axζ = Axis(fig[3, 2], aspect=1, xlabel="x (m)", ylabel="y (m)", width=500, height=400)
...
record(fig, "flow_past_headland.mp4", frames, framerate=14) do i
